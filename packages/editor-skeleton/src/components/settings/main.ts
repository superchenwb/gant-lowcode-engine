import { Node, Designer, Selection, SettingTopEntry } from '@gant-lowcode/lowcode-designer';
import { Editor, obx, computed, makeObservable, action, IEventBus, createModuleEventBus } from '@gant-lowcode/lowcode-editor-core';
