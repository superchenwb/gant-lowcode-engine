import { IProp as InnerProp } from '@gant-lowcode/lowcode-designer';
import { IPublicTypeCompositeValue, IPublicEnumTransformStage, IPublicModelProp, IPublicModelNode } from '@gant-lowcode/lowcode-types';
